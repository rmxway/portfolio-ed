...
export const projects: Project[] = [
  {
    ...
    description:
      "Трекер курсов доллара, евро и юаня к рублю: график за три месяца, селект для переключения валюты, живые данные ЦБ. Интерфейс не моргает при смене котировки — старые цифры остаются, пока грузятся новые. Если запрос упал, значения не пропадают, а ошибка всплывает уведомлением.",
    stack: [
      "Next.js",
      "TypeScript",
      "TanStack Query",
